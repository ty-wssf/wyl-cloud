...
<script>
  import {pageList, getInfo, add, edit, remove} from "@/api/system/dict/data";
  import {pageList as listType, getInfo as getType} from "@/api/system/dict/type";
        ...
        this.$refs["form"].validate(valid => {
          if (valid) {
            if (this.form.dictCode != undefined) {
              edit(this.form.dictCode, this.form).then(response => {
