package cn.wyl.common.core.utils.poi;
...
import cn.wyl.common.core.utils.poi.Excel.Type;
...
public class ExcelUtil<T> {
                    ...
                    if (String.class == fieldType) {
                        ...
                        if (StrUtil.endWith(s, ".0")) {
                            ...
                            if (StrUtil.isNotEmpty(dateFormat)) {
                                val = cn.hutool.core.date.DateUtil.format((Date) val, dateFormat);
                            } else {
                        ...
                        if (val instanceof String) {
                            val = cn.hutool.core.date.DateUtil.parseDateTime((String) val);
    ...
    public void exportExcel(HttpServletResponse response, List<T> list, String sheetName, String title) {
        try {
            ...
            response.setHeader("Content-Disposition", "attachment;filename=" + URLEncoder.encode(sheetName, "UTF8") + ".xlsx");
    ...
    public void setCellVo(Object value, Excel attr, Cell cell) {
        if (ColumnType.STRING == attr.cellType()) {
            ...
            if (StrUtil.isNotEmpty(imagePath)) {
                byte[] data = ResourceUtil.readBytes(imagePath);
