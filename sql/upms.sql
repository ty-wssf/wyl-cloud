...
(
    ...
    update_time datetime comment '更新时间',
    remark      varchar(640) default null comment '备注',
    primary key (user_id)
) engine = innodb
...
(
    ...
    menu_type   char(1)      null comment '菜单类型（M目录 C菜单 F按钮）',
    ...
    update_by   varchar(64)  null comment '更新者',
    update_time datetime comment '更新时间',
    remark      varchar(640) null comment '备注',
    primary key (menu_id)
) engine = innodb
...
-- 三级菜单
insert into sys_menu
values ('640', '操作日志', '108', '1', 'operlog', 'system/operlog/index', '', 1, 0, 'C', '0', '0', 'system:operlog:list',
        'form', 'admin', sysdate(), '', null, '操作日志菜单');
insert into sys_menu
values ('641', '登录日志', '108', '2', 'logininfor', 'system/logininfor/index', '', 1, 0, 'C', '0', '0',
...
-- 操作日志按钮
insert into sys_menu
values ('1040', '操作查询', '640', '1', '#', '', '', 1, 0, 'F', '0', '0', 'system:operlog:query', '#', 'admin', sysdate(),
        '', null, '');
insert into sys_menu
values ('1041', '操作删除', '640', '2', '#', '', '', 1, 0, 'F', '0', '0', 'system:operlog:remove', '#', 'admin', sysdate(),
        '', null, '');
insert into sys_menu
values ('1042', '日志导出', '640', '4', '#', '', '', 1, 0, 'F', '0', '0', 'system:operlog:export', '#', 'admin', sysdate(),
        '', null, '');
-- 登录日志按钮
insert into sys_menu
values ('1043', '登录查询', '641', '1', '#', '', '', 1, 0, 'F', '0', '0', 'system:logininfor:query', '#', 'admin',
        sysdate(), '', null, '');
insert into sys_menu
values ('1044', '登录删除', '641', '2', '#', '', '', 1, 0, 'F', '0', '0', 'system:logininfor:remove', '#', 'admin',
        sysdate(), '', null, '');
insert into sys_menu
values ('1045', '日志导出', '641', '3', '#', '', '', 1, 0, 'F', '0', '0', 'system:logininfor:export', '#', 'admin',
        sysdate(), '', null, '');
-- 在线用户按钮
insert into sys_menu
...
values ('1049', '任务查询', '110', '1', '#', '', '', 1, 0, 'F', '0', '0', 'monitor:job:query', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1064', '任务新增', '110', '2', '#', '', '', 1, 0, 'F', '0', '0', 'monitor:job:add', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
